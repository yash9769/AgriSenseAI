...
export const DashboardScreen = ({ setScreen }: { setScreen: (s: Screen) => void }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      <TopBar title="Overview" activeScreen="dashboard" setScreen={setScreen} />
      
      <div className="flex-1 overflow-y-auto p-6 md:p-8 max-w-7xl mx-auto w-full space-y-8 scrollbar-hide">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-4">
          <div>
            <h1 className="text-4xl font-headline font-extrabold text-primary tracking-tight">Farm Overview</h1>
            <p className="text-on-surface-variant font-medium mt-1">Real-time status synchronizing from IoT nodes.</p>
          </div>
          <button 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-1 rounded-md mb-1">Live</span>
            </div>
            <p className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Humidity</p>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-1 rounded-md mb-1">Current</span>
            </div>
            <p className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Temperature</p>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-1 rounded-md mb-1">Optimized</span>
            </div>
            <p className="text-sm font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Resource Index</p>
          ...
          >
            ...
            <p className="text-sm font-semibold text-white/80 uppercase tracking-wider mb-1 relative z-10">Health Score</p>
            <p className="text-3xl font-headline font-black text-white relative z-10">Syncing...</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mt-8">
          <div className="lg:col-span-2 bg-surface-container-lowest p-6 md:p-8 rounded-[2rem] border border-emerald-900/5 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-headline font-bold text-primary">Farm Activity Outline</h2>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 rounded-xl hover:bg-surface-container-low/50 transition-colors cursor-pointer border border-transparent hover:border-emerald-900/5">
          ...
          <div className="bg-surface-container-lowest p-6 md:p-8 rounded-[2rem] border border-emerald-900/5 shadow-sm flex flex-col">
            <h2 className="text-2xl font-headline font-bold text-primary mb-6">Priorities</h2>
            <div className="flex-1 flex flex-col gap-4">
              <div className="p-5 rounded-2xl bg-error-container text-on-error-container relative overflow-hidden group hover:shadow-md transition-shadow cursor-pointer" onClick={() => setScreen('analysis')}>
                <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <h3 className="font-bold mb-2 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-error animate-pulse"></span>
                  Leaf Blight Risk
                </h3>
                <p className="text-sm opacity-90 leading-relaxed">High risk in Sector B. Immediate fungicide application recommended.</p>
              </div>

              <div className="p-5 rounded-2xl bg-secondary-container text-on-secondary-container relative overflow-hidden group flex-1 flex flex-col justify-center cursor-pointer hover:shadow-md transition-shadow" onClick={() => setScreen('weather')}>
                 <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <h3 className="font-bold mb-2">Upcoming Rain</h3>
                <p className="text-sm opacity-90 leading-relaxed mb-4">60% chance of precipitation tomorrow. Adjust irrigation accordingly.</p>
