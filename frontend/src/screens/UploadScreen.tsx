          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="relative group">
              ...
              <div className="relative bg-surface-container-lowest border-2 border-dashed border-emerald-900/20 rounded-[2rem] p-12 transition-all duration-300 hover:border-emerald-800/40 min-h-[400px] flex flex-col items-center justify-center text-center">
                ...
                <button className="signature-gradient text-white px-8 py-4 rounded-full font-headline font-bold flex items-center gap-3 shadow-lg shadow-emerald-900/10 hover:shadow-emerald-900/20 transition-all active:scale-95">
            ...
            <div className="bg-surface-container-low rounded-[1.5rem] p-6 flex items-center gap-6 border border-emerald-900/5">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="h-3 w-32 bg-surface-container-highest rounded animate-pulse"></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-surface-container-lowest rounded-[2rem] overflow-hidden shadow-sm border border-emerald-900/5">
              <div className="aspect-square relative group">
                <img 
                  ...
                  src="https://images.unsplash.com/photo-1592419044706-39796d40f98c?auto=format&fit=crop&q=80&w=600" 
                  alt="Leaf preview" 
                />
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-white font-headline font-bold truncate">Corn_Leaf_042.jpg</p>
                  </div>
                  <button className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center hover:bg-white/40 transition-colors">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs text-on-surface-variant">2.4 MB</span>
                </div>
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm text-on-surface">Oct 24, 2023 · 09:42 AM</p>
                  </div>
                </div>
                <button 
